package com.cxb.library.widget.xListView;
 ...
 */
public
class XListView extends ListView implements OnScrollListener {
    private float mLastY = -1; // save event y
    private Scroller mScroller; // used for scroll back
    private OnScrollListener mScrollListener; // user's scroll listener

    // the interf to trigger refresh and load more.
    ...
    /**
     * implements this interf to get refresh/load more event.
     */
