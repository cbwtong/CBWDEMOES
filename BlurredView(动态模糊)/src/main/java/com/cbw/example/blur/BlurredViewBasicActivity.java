...
import com.cbw.example.blur.util.BlurredView;
...
public
class
BlurredViewBasicActivity extends AppCompatActivity {
    /**
     * 进度条SeekBar
     */
    ...
    private void initViews() {
        ...
        mBlurredView.setBlurredImg(getResources().getDrawable(R.mipmap.vs));
